...
For the investigated range, the coupling coefficient decreases as the gap increases.
...
Within the investigated range, the coupling coefficient decreases as the waveguide width increases.
